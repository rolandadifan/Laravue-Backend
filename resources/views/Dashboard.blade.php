...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="text-dark ml-3 mr-5">Dashboard</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          </div><!-- /.col -->
        </div><!-- /.row -->
                                        ...
                                        <table class="table ">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class=" pb-0">
                                                    ...
                                                    <td>{{$itm->address}}</td>
                                                    <td>
                                                        @if($itm->transaction_status == 'PENDING')
                                                        <span class="badge badge-info">
                                                        @elseif($itm->transaction_status == 'SUCCES')
                                                        <span class="badge badge-success">
                                                        @elseif($itm->transaction_status == 'FAILED')
  ...
  @yield('content')
  <footer class="main-footer fixed-bottom pt-0">
